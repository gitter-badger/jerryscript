...
typedef struct
{
  ...
  lexer_line_counter line;                   /**< token start line */
  lexer_line_counter column;                 /**< token start column */
  lexer_literal_location literal_location;   /**< extra data for character literals */
} lexer_token;
...
typedef struct
{
  lexer_literal *literal_p;                  /**< pointer to the literal object */
  uint16_t index;                            /**< literal index */
  uint8_t type;                              /**< literal object type */
} lexer_literal_object;
